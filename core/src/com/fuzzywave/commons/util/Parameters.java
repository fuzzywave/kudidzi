...
public interface Parameters {
     ...
     * @param id  The identifier of the object in the map.
     */
    <T> T get(String id);
     ...
     * @param <T>          The type of the returned object.
     * @param id           The identifier of the object in the map.
     * @param defaultValue The default value of the returned object if the map doesn't contains any object identified by id.
     */
     ...
     *
     * @param values A map of values to add to the parameters.
     */
